#!/usr/bin/env python3
"""Fine-grained entropy scan around critical λ"""
...
# Fine-grained scan around critical region
lams = [0.005, 0.008, 0.009, 0.010, 0.011, 0.012, 0.015, 0.02]

print("Fine-grained entropy scan around λ_critical:")
print("="*40)
