"""
BASELINE vs SLOT - FIXED VERSION
Now both use ALL frames fairly
"""
import numpy as np
import torch
...
print("="*60)
print("BASELINE vs SLOT - FAIR COMPARISON")
print("="*60)
...
# Baseline: standard CNN with all frames
...
# Slot: with object structure - NOW USES ALL FRAMES!
class Slot(nn.Module):
    ...
    def forward(self, x0, x5, x10):
        ...
        # Use slot 0 for all predictions
...
print(f"\nSlot vs Baseline: {(mse_b - mse_s) / mse_b * 100:+.1f}%")
