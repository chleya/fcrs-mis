"""
Identity Test - FULL RANDOM (identity MUST be tracked)
"""
import numpy as np
import torch
...
print("="*60)
print("IDENTITY TEST - FULL RANDOM")
print("="*60)
...
def generate_data(n=5000):
    ...
    for _ in range(n):
        # COMPLETELY RANDOM setup each time
        # Ball A and B start at random positions
        x_a = random.uniform(5, 15)
        y_a = random.uniform(5, 27)
        x_b = random.uniform(17, 27)
        y_b = random.uniform(5, 27)
        ...
        # Target: ball A position (the RED one!)
