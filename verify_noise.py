"""
Verify random_noise intervention with multiple seeds
"""
...
# Data with random noise intervention
...
for _ in range(400):
    ...
    for _ in range(10):
        a = np.random.randint(0, 2)
        sn = step(s, a)
        sn += np.random.randn(4) * 0.5  # Noise intervention
